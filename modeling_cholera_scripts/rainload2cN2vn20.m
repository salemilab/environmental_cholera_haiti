...
aH=prod(a1h,2);
aE=prod(a1e,2);
Td=load('timeD1tdccsn2Ahcs2fAsEc2copy2Epcs23fcb0xc3c.mat');
Yd=load('stYD1tdccsn2Ahcs2fAsEc2copy2Epcs23fcb0xc3c.mat');
ne1=load('neD1tdccsn2Ahcs2fAsEc2copy2Epcs23fcb0xc3c.mat');
pep1=load('pepD1tdccsn2Ahcs2fAsEc2copy2Epcs23fcb0xc3c.mat');

Td0=load('timeD1tdccsn2Ahcs2fAsEc2copy2Epcs23fcb0xc2.mat');
Yd0=load('stYD1tdccsn2Ahcs2fAsEc2copy2Epcs23fcb0xc2.mat');
ne0=load('neD1tdccsn2Ahcs2fAsEc2copy2Epcs23fcb0xc2.mat');

Td0n=load('timeD1tdccsn2Ahcs2fAsEc2copy2Epcs23fcb0xc3.mat');
Yd0n=load('stYD1tdccsn2Ahcs2fAsEc2copy2Epcs23fcb0xc3.mat');
ne0n=load('neD1tdccsn2Ahcs2fAsEc2copy2Epcs23fcb0xc3.mat');

Td0nc=load('timeD1tdccsn2Ahcs2fAsEc2copy2Epcs23fcb0xc3c.mat');
Yd0nc=load('stYD1tdccsn2Ahcs2fAsEc2copy2Epcs23fcb0xc3c.mat');
ne0nc=load('neD1tdccsn2Ahcs2fAsEc2copy2Epcs23fcb0xc3c.mat');

Tdv1=load('timeD1tdccsn2Ahcs2fAsEc2copy2nE3cbv01_0.mat');
Ydv1=load('stYD1tdccsn2Ahcs2fAsEc2copy2nE3cbv01_0.mat');  %3c
nev1=load('neD1tdccsn2Ahcs2fAsEc2copy2nE3cbv01_0.mat');

Tdv2=load('timeD1tdccsn2Ahcs2fAsEc2copy2nE2bv01_0.mat');
Ydv2=load('stYD1tdccsn2Ahcs2fAsEc2copy2nE2bv01_0.mat');
nev2=load('neD1tdccsn2Ahcs2fAsEc2copy2nE2bv01_0.mat');

Tdv3=load('timeD1tdccsn2Ahcs2fAsEc2copy2nE3bv01_0.mat');
Ydv3=load('stYD1tdccsn2Ahcs2fAsEc2copy2nE3bv01_0.mat');
nev3=load('neD1tdccsn2Ahcs2fAsEc2copy2nE3bv01_0.mat');
...
Yhv1=N*Yv1(2:m+1,:);
%T1=T1(1:end-ss);
Yhv2=N*Yv2(2:m+1,2:end);
Yhv3=N*Yv3(2:m+1,2:end);
Y3s=Y3(1,:)*N;
...
size(Cases2)
size(T0)
casesvac2(Tdat,Casesd,T0(2:end),[Cases(2:end);Cases2;Cases3],T1,Casesv1,T2,Casesv2,T3,Casesv3)
% for i=1:20
% figure(10)
