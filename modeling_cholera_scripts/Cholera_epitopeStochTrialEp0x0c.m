...
if isnan(X)~=zeros(size(X))
 ...
 save('timeD1tdccsn2Ahcs2fAsEc2copy2Epcs23fcb0xc3c.mat','T')
save('stYD1tdccsn2Ahcs2fAsEc2copy2Epcs23fcb0xc3c.mat','Y')
save('neD1tdccsn2Ahcs2fAsEc2copy2Epcs23fcb0xc3c.mat','ne')
save('pepD1tdccsn2Ahcs2fAsEc2copy2Epcs23fcb0xc3c.mat','pep')
save('neHD1tdccsn2Ahcs2fAsEc2copy2Epcs23fcb0xc3c.mat','neH')
save('pepHD1tdccsn2Ahcs2fAsEc2copy2Epcs23fcb0xc3c.mat','pepH')
figure(1)
plot(T,vlH/4)
